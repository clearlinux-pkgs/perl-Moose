...
Source0  : https://cpan.metacpan.org/authors/id/E/ET/ETHER/Moose-2.2202.tar.gz
...
%prep
%setup -q -n Moose-2.2202
cd %{_builddir}/Moose-2.2202
...
cp %{_builddir}/Moose-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-Moose/8e15b0a66ff62e8d2999acc233abfab0c78071d9 || :
if test -f Makefile.PL; then
