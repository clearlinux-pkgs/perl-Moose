...
Source0  : https://cpan.metacpan.org/authors/id/E/ET/ETHER/Moose-2.4000.tar.gz
...
%prep
%setup -q -n Moose-2.4000
cd %{_builddir}/Moose-2.4000
pushd ..
cp -a Moose-2.4000 buildavx2
popd
pushd ..
cp -a Moose-2.4000 buildapx
popd
